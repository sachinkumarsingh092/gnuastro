...
parse_opt(int key, char *arg, struct argp_state *state)
{
  ...
  switch(key)
    ...
    case 'B':
      ...
      break;
    case 'F':
      gal_checkset_sizet_l_zero(arg, &p->minnumfalse, "minnumfalse", key, SPACK,
                                NULL, 0);
    ...
    case 'l':
      ...
      break;
    case 'a':
      gal_checkset_sizet_l_zero(arg, &p->smp.nch1, "nch1", key, SPACK, NULL, 0);
      p->up.nch1set=1;
      break;
    case 'b':
      gal_checkset_sizet_l_zero(arg, &p->smp.nch2, "nch2", key, SPACK, NULL, 0);
      p->up.nch2set=1;
      break;
    case 'L':
      gal_checkset_float_l_0_s_1(arg, &p->smp.lastmeshfrac, "lastmeshfrac", key,
                                 SPACK, NULL, 0);
    ...
    case 'i':
      ...
      break;
    case 510:
      gal_checkset_sizet_el_zero(arg, &p->detsnhistnbins, "detsnhistnbins", key,
                                 SPACK, NULL, 0);
    ...
    case 514:
      gal_checkset_sizet_el_zero(arg, &p->segsnhistnbins, "segsnhistnbins", key,
                                 SPACK, NULL, 0);
