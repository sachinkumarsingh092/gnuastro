...
img=mkprofcat1.fits
$execname $img $cat --imgmode --polygon=209,50:436.76,151:475.64,438.2:210.6,454.04:121.4,289.88 --zeroisnotblank --outpolygon --keepblankcenter
mv mkprofcat1_crop.fits imgoutpolygon.fits
